  ...
  server.tool(
    ...
    'Generate a TypeORM entity file following LaunchFrame conventions.',
    {
      ...
      withEnum: z
        ...
        .optional()
        .describe(
          'Optional: define a status enum. Provide enum name in PascalCase (e.g. "EntryStatus"). Values will be a placeholder — edit as needed.'
        ),
    },
    async ({
      entityName,
